    ...
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-black py-20">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4 mt-4 w-full max-w-2xl px-2 sm:px-0">
            <Link href="/#register" className="cyber-button text-[8px] sm:text-[10px] md:text-sm px-2 sm:px-6 py-4 md:py-3 glitch-hover w-full" data-text="INITIATE REGISTRATION">
